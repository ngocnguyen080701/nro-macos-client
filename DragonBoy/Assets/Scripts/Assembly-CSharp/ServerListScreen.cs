...
public class ServerListScreen : mScreen, IActionListener
{
	...
	public static string LOCAL_SERVER = "Server Local:127.0.0.1:14445:0,0,0";

	public static string smartPhoneVN = LOCAL_SERVER;

	public static string javaVN = LOCAL_SERVER;

	public static string smartPhoneIn = LOCAL_SERVER;

	public static string javaIn = LOCAL_SERVER;

	public static string smartPhoneE = LOCAL_SERVER;

	public static string javaE = LOCAL_SERVER;
